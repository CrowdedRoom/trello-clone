          ...
          <div className='flex min-h-full items-center justify-center p-4 text-center'>
            ...
            >
              <Dialog.Panel
                ...
                text-left align-middle shadow-xl trannsistion-all'
              >
                <Dialog.Title
                  as='h3'
                ...
                <div className=''>
                  ...
                  {image && (
                    <Image
                      ...
                      width={200}
                      height={200}
                      className='w-full h-44 object-cover mt-2 filter hover:grayscale transistion-all duration-150 cursor-not-allowed'
                      onClick={() => {
                        setImage(null);
                      }}
                    />
                ...
                <div className='mt-4'>
                  <button
                    ...
                    focus-visible:ringblue-500 focus-visible:ring-offset-2 disabled:bg-gray-100 disabled:text-gray-300
